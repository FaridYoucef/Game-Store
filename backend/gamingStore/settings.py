...
SECRET_KEY = 'django-insecure-)kod0)+ehpg831&0o+(js*-ya1j)r4o@*w1pm9z91a9%0uf8*x'
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_AUTHENTICATION_CLASSES': [
        # No authentication classes needed if you want public access
    ],
}
...
DATABASES = {
    'default': {
        ...
        'NAME': 'gaming_store',
        'USER': 'game',
        'PASSWORD': 'Gamegamegame123456789',
        'HOST': 'localhost',
        'PORT': '5432',
    }
}
